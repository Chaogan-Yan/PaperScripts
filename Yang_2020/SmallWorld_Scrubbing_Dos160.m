...
ToUpDir = '/mnt/Data/RfMRILab/Yan/YAN_Work/REST-meta-MDD/Processing/SmallWorld/SmallWorld/Dos160SmallWorld/AllSM_Scrubbing';

OutputTempDir='/mnt/Data2/RfMRILab/Yan/Yan_Work/REST-meta-MDD/SmallWorld/SmallWordTempScrubbing';
mkdir(OutputTempDir)
...
save([OutputDir,filesep,'SubInfo.mat'],'SubID','Dx','Age','Sex','Edu','Site','Motion');
