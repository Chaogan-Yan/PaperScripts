clear;clc
parpool(20)
datapath='/mnt/Data3/RfMRILab/Lihuixian/DataAnalysis/TaskAnalysis/2020Relationship/MVPA/sortdataAH';
outpath='/mnt/Data3/RfMRILab/Lihuixian/DataAnalysis/TaskAnalysis/2020Relationship/MVPA/MVPAresultR5';
mkdir(outpath)
...
parfor isub=1:size(subid,1)
    ...
    ds=cosmo_fmri_dataset(subpath,'mask',maskpath,...
        'targets',repmat((1:2)',4,1),...  %2condition
        'chunks',floor(((1:8)-1)/2)'+1);  %2condition   total8
