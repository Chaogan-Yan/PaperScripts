clear;clc
parpool(20)
datapath='/mnt/Data3/RfMRILab/Lihuixian/DataAnalysis/TaskAnalysis/2020FrameLine/2022MVPA/sortdataReAb';
outpath='/mnt/Data3/RfMRILab/Lihuixian/DataAnalysis/TaskAnalysis/2020FrameLine/2022MVPA/MVPA2ReAb/MVPAresultR5';
mkdir(outpath)
...
parfor isub=1:size(subid,1)
    ...
    ds=cosmo_fmri_dataset(subpath,'mask',maskpath,...
        'targets',repmat((1:2)',12,1),...  %2condition  Relative vs. Absolute
        'chunks',floor(((1:24)-1)/2)'+1);  %2condition   total24
