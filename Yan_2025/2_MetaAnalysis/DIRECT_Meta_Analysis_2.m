...
DataDir='/mnt/Data7/RfMRILab/Yan/YAN_Work/REST_meta-MDD_Surf/Analysis/MetaAnalysis/AfterQCExclusion/DIRECT_ENIGMA/DIRECT_ENIGMAData';

OutputDir='/mnt/Data7/RfMRILab/Yan/YAN_Work/REST_meta-MDD_Surf/Analysis/MetaAnalysis/AfterQCExclusion/DIRECT_ENIGMA/MetaAnalysis_DIRECT_ENIGMA_AllSites_CohenDMaps_RemoveEmptySites';
...
OutputDir='/mnt/Data7/RfMRILab/Yan/YAN_Work/REST_meta-MDD_Surf/Analysis/MetaAnalysis/AfterQCExclusion/DIRECT_ENIGMA/MetaRegression/AllMetaRegressions_Model1';



SiteInfo=readtable('/mnt/Data7/RfMRILab/Yan/YAN_Work/REST_meta-MDD_Surf/Analysis/SubInfo/QC/Sites_info_all_AfterQC.xlsx');
...
for iSubjectsPool = 1:length(SubjectsPoolSet)
    for iMeasure = 1:length(MeasureSet)
        ...
        DIRECT_Meta_Regression_Model1(DataDir,OutputDir,AllSiteNames,SubjectsPool,  Measure, SiteInfo);
    end
end
