function ENIGMA_RMD_Vertex_Stats_FixModel7(DataDir,CovariatesFile,MinimumSubjectNumber,ParallelWorkersNumber,IsDPABISurfDataStyle,FreesurferSubjectsDir)
...
mkdir(OutDir);
ENIGMA_RMD_Vertex_FixModel7(DataDir,OutDir,Table,MinimumSubjectNumber,IsDPABISurfDataStyle);
...
ENIGMA_RMD_Vertex_FixModel7(DataDir,OutDir,TableAdolescent,MinimumSubjectNumber,IsDPABISurfDataStyle);
...
ENIGMA_RMD_Vertex_FixModel7(DataDir,OutDir,TableAdult,MinimumSubjectNumber,IsDPABISurfDataStyle);


fprintf('\n\tCongratulations! Perform ALL Stats for ENIGMA & REST-meta-MDD collaborative studies on vertex Thickness and Area within each site: Fix Model7: Finished!!!\n');
