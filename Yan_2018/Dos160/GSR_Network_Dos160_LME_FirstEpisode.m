...
load /mnt/Data/RfMRILab/Yan/YAN_Work/REST-meta-MDD/Processing/NetworkAnalysis/zROICorr/ROISignals_FunImgARglobalCWF/Dos160_ROICorrelation_FisherZ_Set.mat
...
SignificantIndex=[1 3; 1 7; 2 2; 5 5; 7 7];
Ind = sub2ind([7 7], SignificantIndex(:,1),SignificantIndex(:,2));
PVectorR = PMatrix(Ind);
[pIDR,pNR] = FDR(PVectorR,0.05);

disp(SignificantIndex(find(PVectorR<=pIDR),:))
