function f_DFC_W_sect(data_path, tpl_path, output_path, mask_path, WinLength, WinStep, WinType, data_sect)
...
%     fprintf('\nProcessing Seg %g of total %g segments\n', iCut, CutNumber);
    if iCut~=CutNumber
